        ...
        <div class="row flex-nowrap">
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 sidebarColor">
                <div
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item d-flex align-items-center mt-2 mb-2">
                            <a href="PolinemaToday.php" class="nav-link align-middle bg-white">
                                ...
                                <span class="ms-1 d-none d-sm-inline"
                                    style="color: #483D8B;"><strong>PolinemaToday</strong></span>
                            </a>
                        </li>
                        <li class="nav-item d-flex align-items-center mt-2 mb-2">
            ...
            <div class="col py-3" style="background-color: #e9e6fd;">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 style="color: #483D8B"><strong>PolinemaToday</strong></h1>
                ...
                <div class="p-3 bg-white rounded">
                    <p style="color: #483D8B;"><strong>Berita</strong></p>
