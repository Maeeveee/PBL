            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 sidebarColor">
                <div
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item d-flex align-items-center mt-2 mb-2">
                            <a href="/myWeb/PBL/frontend/Dosen/PolinemaToday.php" class="nav-link align-middle"
                                onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)';"
                                onmouseout="this.style.backgroundColor='transparent';">
                        ...
                        <li class="nav-item d-flex align-items-center mt-2 mb-2">
                            <a href="/myWeb/PBL/frontend/Dosen/Pelanggaran.php" class="nav-link align-middle"
                                onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)';"
                                onmouseout="this.style.backgroundColor='transparent';">
                        ...
                        <li class="nav-item d-flex align-items-center mt-2 mb-2">
                            <a href="/myWeb/PBL/frontend/Dosen/Notifikasi.php" class="nav-link align-middle"
                                onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)';"
                                onmouseout="this.style.backgroundColor='transparent';">
